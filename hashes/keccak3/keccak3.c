...
// Initialize the context for KECCAK3

int keccak3_init(keccak3_ctx_t *c, int mdlen)
{
    int i;
...
int keccak3_final(void *md, keccak3_ctx_t *c)
{
    int i;
...
void *keccak3_hash(const void *in, size_t inlen, void *md, int mdlen)
{
    ...
    keccak3_init(&keccak3, mdlen);
    keccak3_update(&keccak3, in, inlen);
    keccak3_final(md, &keccak3);
