...
void F8(jh_state_t *state);    /* the compression function F8 */

/*The API functions*/
int Init(jh_state_t *state, int hashbitlen);
int Update(jh_state_t *state, const BitSequence *data, DataLength databitlen);
int Final(jh_state_t *state, BitSequence *hashval);
